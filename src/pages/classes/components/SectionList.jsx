...
const SectionList = ({ sections = [], onEdit, onDelete, onReassign }) => (
      ...
      <div key={section._id} className="flex flex-col gap-4 rounded-glass-sm bg-white/50 p-4 lg:flex-row lg:items-center lg:justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-on-surface-variant">
            Teacher: {section.classTeacher?.name || 'Unassigned'} · Room: {section.roomNumber || '—'} · Students: {section.studentCount || 0}
          </p>
        </div>
